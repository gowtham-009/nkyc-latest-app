<template>
    <div class="w-full">
      <label for="pan_label" class="text-gray-500 text-lg font-normal">Address line 2</label>
      <InputText
        id="pan_label"
        class="w-full py-2"
        v-model="address2"
        ...
        maxlength="100"
        size="large"
        placeholder="Nominee's address line 2"
      />
    </div>
  </template>
  ...
  const address2 = ref(props.modelValue || '');
